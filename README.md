...
### Cinematic Shorts Engine foundation

Added:
- `video/caption_generator.py`
- `video/thumbnail_generator.py`
- `video/text_utils.py`

New capabilities:
- professional caption overlay cards
- scene-aware captions
- automatic thumbnail generation
- stronger motion/pacing
- cleaner cinematic vertical Shorts layout

This is not yet word-level subtitle syncing, but it gives videos a more polished news-short feel.
