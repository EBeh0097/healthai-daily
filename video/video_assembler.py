...
from video.scene_router import get_story_scenes, get_last_scene_error
...
def assemble_short_video(
    ...
    scenes = get_story_scenes(title=title, region=region, source=source, snippet=snippet, script_text=script_text, output_dir=output_dir, use_ai_images=use_ai_images)
